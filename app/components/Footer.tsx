      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-white/80 max-w-2xl mx-auto mb-8">
            I&apos;m an AI Engineer Trainee at Trianz, with an MCA from NIT Bhopal, and I build scalable real-time systems using Kafka, Spring Boot, Trino, and modern full-stack tooling.
          </p>
          <a
            href="https://github.com/Officialdeepankar"
            target="_blank"
            rel="noopener noreferrer"
            className="text-md text-purple-400 hover:text-purple-300 transition-colors"
          >
            github.com/Officialdeepankar
          </a>
        </div>
