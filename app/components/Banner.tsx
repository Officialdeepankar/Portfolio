...
export default function Banner(): React.JSX.Element {
  const texts = ["AI Engineer", "Java Full Stack Developer"];
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center ">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Hello! I Am{" "}
                      <span className="text-purple-400">Deepankar Singh</span>
                    </p>
                  </div>
              ...
              <Image
                src="/assets/me1.png"
                alt="Deepankar Singh - AI Engineer and Full Stack Developer"
                width={300}
                height={300}
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="">
              ...
              <p className="text-md text-white/80">
                Transforming complex problems into elegant technical solutions
              </p>
            </div>
          </div>
        </div>
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Currently, I&apos;m an AI Engineer Trainee at</span>
            <span className="flex items-center gap-2">
              <span className="text-purple-400 font-semibold">Trianz,</span>
            </span>
          </p>
          <p className="text-lg text-white/80 max-w-2xl mt-15 mx-auto lg:mx-0">
            As an AI-driven full-stack developer with over 1.1+ years of experience, I specialize in building scalable microservices and
real-time, event-driven backend systems using Java, Spring Boot, and Apache Kafka. I also develop AI agent systems using
LangChain and LangGraph, with hands-on experience leveraging AI tools to rapidly build and ship features.
          </p>
        </div>
      </div>
    </section>
